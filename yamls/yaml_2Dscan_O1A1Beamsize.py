...
yaml_template = '/home/yu79deg/darkfield_p5438/yamls/LP_917.yaml' #name of the template yaml file that we modify
...
param_dict = {
    'O1_size': [150.0, 200.0, 300.0, 400.0], 'A1_size': [50.0, 70.0, 100.0, 120.0, 150.0, 200.0], 
}

# BE CAREFUL : HERE THE O1_SIZE ALSO CHANGES THE BEAM_SHAPER.
...
for i, combo in enumerate(combinations):
    ...
    if 'O1_size' in params:
        ...
        if O1_s==0:
            ...
            ip['beam_shaper']['size'] = O1_s * 1e-6 / 3.2 #The factor 3.2 is to get down to 0.1% of the gaussian maximum at the edge of the aperture.
