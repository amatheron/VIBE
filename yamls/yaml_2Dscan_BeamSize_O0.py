...
yaml_template = '/home/yu79deg/darkfield_p5438/yamls/LP_831.yaml' #name of the template yaml file that we modify
...
param_dict = {
    'O0_size': [ 180.0, 200.0, 220.0 , 240.0], 'BS_size': [350.0, 500.0], 
}
