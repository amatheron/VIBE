...
yaml_template = '/home/yu79deg/darkfield_p5438/yamls/LP_410.yaml' #name of the template yaml file that we modify
...
param_dict = {
    'TCSlit_size': [0.0,2.0,5.0,10.0,15.0,20.0,30.0,40.0,50.0], 'wide_factor': [0.4, 0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.4], 
}
