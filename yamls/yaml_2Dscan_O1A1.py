...
yaml_template = '/home/yu79deg/VIBE/yamls/LP_962.yaml' #name of the template yaml file that we modify
outdir = '/home/yu79deg/VIBE/yamls' # folder where it will save the generate yamls
...
param_dict = {
    'O1_size': [250.0, 300.0, 350.0, 400.0], 'A1_size': [90.0, 100.0, 110.0, 120.0, 130.0], 
}
